...
//
//     final createCouponResponse = createCouponResponseFromJson(jsonString);

import 'package:freezed_annotation/freezed_annotation.dart';
import 'dart:convert';

part 'create_coupon_response.freezed.dart';
part 'create_coupon_response.g.dart';

CreateCouponResponse createCouponResponseFromJson(String str) =>
    CreateCouponResponse.fromJson(json.decode(str));

String createCouponResponseToJson(CreateCouponResponse data) =>
    json.encode(data.toJson());

@freezed
class CreateCouponResponse with _$CreateCouponResponse {
  const factory CreateCouponResponse({
  ...
  }) = _CreateCouponResponse;

  factory CreateCouponResponse.fromJson(Map<String, dynamic> json) =>
      _$CreateCouponResponseFromJson(json);
}
