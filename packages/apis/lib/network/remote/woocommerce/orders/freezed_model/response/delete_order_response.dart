...
//
//     final deleteOrderResponse = deleteOrderResponseFromJson(jsonString);
...
DeleteOrderResponse deleteOrderResponseFromJson(String str) =>
    DeleteOrderResponse.fromJson(json.decode(str));

String deleteOrderResponseToJson(DeleteOrderResponse data) =>
