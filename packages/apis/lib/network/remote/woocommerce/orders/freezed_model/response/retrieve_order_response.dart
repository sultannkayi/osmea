...
//
//     final retrieveOrderResponse = retrieveOrderResponseFromJson(jsonString);

import 'package:freezed_annotation/freezed_annotation.dart';
import 'dart:convert';

part 'retrieve_order_response.freezed.dart';
part 'retrieve_order_response.g.dart';
...
RetrieveOrderResponse retrieveOrderResponseFromJson(String str) =>
    RetrieveOrderResponse.fromJson(json.decode(str));

String retrieveOrderResponseToJson(RetrieveOrderResponse data) =>
    json.encode(data.toJson());

@freezed
class RetrieveOrderResponse with _$RetrieveOrderResponse {
  const factory RetrieveOrderResponse({
    @StringToIntConverter() @JsonKey(name: "id") int? id,
    @StringToIntConverter() @JsonKey(name: "parent_id") int? parentId,
    ...
    @StringToIntConverter() @JsonKey(name: "customer_id") int? customerId,
...
class LineItem with _$LineItem {
  const factory LineItem({
    ...
    @StringToIntConverter() @JsonKey(name: "product_id") int? productId,
    @StringToIntConverter() @JsonKey(name: "variation_id") int? variationId,
    @StringToIntConverter() @JsonKey(name: "quantity") int? quantity,
    ...
    @StringToIntConverter() @JsonKey(name: "price") int? price,
