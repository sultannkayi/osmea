...
//
//     final listAllProductsResponse = listAllProductsResponseFromJson(jsonString);

import 'package:freezed_annotation/freezed_annotation.dart';
import 'dart:convert';

part 'list_all_products_response.freezed.dart';
part 'list_all_products_response.g.dart';

List<ListAllProductsResponse> listAllProductsResponseFromJson(String str) =>
    List<ListAllProductsResponse>.from(
        json.decode(str).map((x) => ListAllProductsResponse.fromJson(x)));

String listAllProductsResponseToJson(List<ListAllProductsResponse> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

@freezed
class ListAllProductsResponse with _$ListAllProductsResponse {
  const factory ListAllProductsResponse({
  ...
  }) = _ListAllProductsResponse;

  factory ListAllProductsResponse.fromJson(Map<String, dynamic> json) =>
      _$ListAllProductsResponseFromJson(json);
}
