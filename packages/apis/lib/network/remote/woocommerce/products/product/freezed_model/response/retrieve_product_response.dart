...
//
//     final retrieveProductResponse = retrieveProductResponseFromJson(jsonString);

import 'package:freezed_annotation/freezed_annotation.dart';
import 'dart:convert';

part 'retrieve_product_response.freezed.dart';
part 'retrieve_product_response.g.dart';

RetrieveProductResponse retrieveProductResponseFromJson(String str) =>
    RetrieveProductResponse.fromJson(json.decode(str));

String retrieveProductResponseToJson(RetrieveProductResponse data) =>
    json.encode(data.toJson());

@freezed
class RetrieveProductResponse with _$RetrieveProductResponse {
  const factory RetrieveProductResponse({
