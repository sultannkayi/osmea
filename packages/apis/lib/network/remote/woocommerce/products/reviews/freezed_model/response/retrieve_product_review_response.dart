...
//
//     final retrieveProductReviewResponse = retrieveProductReviewResponseFromJson(jsonString);

import 'package:freezed_annotation/freezed_annotation.dart';
import 'dart:convert';

part 'retrieve_product_review_response.freezed.dart';
part 'retrieve_product_review_response.g.dart';

RetrieveProductReviewResponse retrieveProductReviewResponseFromJson(
        String str) =>
    RetrieveProductReviewResponse.fromJson(json.decode(str));

String retrieveProductReviewResponseToJson(
        RetrieveProductReviewResponse data) =>
    json.encode(data.toJson());

@freezed
class RetrieveProductReviewResponse with _$RetrieveProductReviewResponse {
  const factory RetrieveProductReviewResponse({
  ...
  }) = _RetrieveProductReviewResponse;

  factory RetrieveProductReviewResponse.fromJson(Map<String, dynamic> json) =>
      _$RetrieveProductReviewResponseFromJson(json);
}
