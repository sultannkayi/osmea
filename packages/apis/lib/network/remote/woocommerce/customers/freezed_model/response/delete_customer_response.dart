...
//
//     final deleteCustomerResponse = deleteCustomerResponseFromJson(jsonString);

import 'package:freezed_annotation/freezed_annotation.dart';
import 'dart:convert';

part 'delete_customer_response.freezed.dart';
part 'delete_customer_response.g.dart';

DeleteCustomerResponse deleteCustomerResponseFromJson(String str) =>
    DeleteCustomerResponse.fromJson(json.decode(str));

String deleteCustomerResponseToJson(DeleteCustomerResponse data) =>
    json.encode(data.toJson());

@freezed
class DeleteCustomerResponse with _$DeleteCustomerResponse {
  const factory DeleteCustomerResponse({
