...
//
//     final retrieveCustomerResponse = retrieveCustomerResponseFromJson(jsonString);

import 'package:freezed_annotation/freezed_annotation.dart';
import 'dart:convert';

part 'retrieve_customer_response.freezed.dart';
part 'retrieve_customer_response.g.dart';

RetrieveCustomerResponse retrieveCustomerResponseFromJson(String str) =>
    RetrieveCustomerResponse.fromJson(json.decode(str));

String retrieveCustomerResponseToJson(RetrieveCustomerResponse data) =>
    json.encode(data.toJson());

@freezed
class RetrieveCustomerResponse with _$RetrieveCustomerResponse {
  const factory RetrieveCustomerResponse({
