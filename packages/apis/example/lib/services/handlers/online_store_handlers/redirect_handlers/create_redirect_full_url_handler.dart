...
class CreateRedirectFullUrlHandler implements ApiRequestHandler {
  @override
  Future<Map<String, dynamic>> handleRequest(
    ...
    try {
      ...
      final redirectRequest = CreateRedirectFullUrlRequest.fromJson(requestJson);
  ...
  Map<String, List<ApiField>> get requiredFields => {
    'POST': [
      ...
      const ApiField(
        name: 'target',
        label: 'Target',
        hint: 'The destination of the redirect (e.g., /new-path or https://example.com)',
        isRequired: true,
      ),
    ],
  };
