...
///*******************************************************************
///************** 🏷️ LIST MOST POPULAR TAGS FOR SPECIFIC BLOG HANDLER 🏷️ ********
///*******************************************************************

class ListMostPopularTagsSpecificBlogHandler implements ApiRequestHandler {
  @override
  Future<Map<String, dynamic>> handleRequest(
    ...
    if (method == 'GET') {
      ...
      try {
        ...
        final response =
            await GetIt.I.get<ArticleService>().listMostPopularTagsSpecificBlog(
