...
class CreateUnpublishedCustomCollectionHandler implements ApiRequestHandler {
  @override
  Future<Map<String, dynamic>> handleRequest(
    ...
    try {
      // Creating the correct request type - CreateUnpublishedCustomCollectionRequest
      final collectionRequest = CreateUnpublishedCustomCollectionRequest(
          customCollection: CustomCollection(title: title, published: false));
      ...
      return {
        "status": "success",
        "message": "Unpublished custom collection created successfully",
      ...
      return {
        "status": "error",
        "message":
            "Failed to create unpublished custom collection: ${e.toString()}",
        "timestamp": DateTime.now().toIso8601String(),
      };
    }
  }
