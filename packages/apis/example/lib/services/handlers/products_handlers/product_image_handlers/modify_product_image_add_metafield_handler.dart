...
class ModifyProductImageAddMetafieldHandler implements ApiRequestHandler {
  ...
  @override
  Future<Map<String, dynamic>> handleRequest(String method, Map<String, String> params) async {
    if (method != 'PUT') {
      return {
        'status': 'error',
    ...
    try {
      final response = await GetIt.I<ProductImageService>().modifyProductImageAddMetafield(
