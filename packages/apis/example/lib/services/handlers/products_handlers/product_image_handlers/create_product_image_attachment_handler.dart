...
import 'package:apis/network/remote/products/product_image/freezed_model/request/create_a_new_product_image_request.dart' as req;
  ...
  Future<Map<String, dynamic>> handleRequest(
    ...
    if (productId == null || src == null) {
      ...
      try {
        ...
        if (!uri.hasScheme || !uri.hasAuthority) {
          return {
            ...
            "details": "Please provide a valid image URL with scheme (http/https)",
            "timestamp": DateTime.now().toIso8601String(),
          };
        }
      } catch (e) {
      ...
      if (errorMessage.contains('404')) {
        statusCode = 404;
        errorMessage = "Product not found. Please verify the product ID exists.";
