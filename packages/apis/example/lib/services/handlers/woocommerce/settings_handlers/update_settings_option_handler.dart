...
class UpdateSettingsOptionHandler implements ApiRequestHandler {
  ...
  Future<Map<String, dynamic>> handleRequest(
    ...
    if (method != 'PUT') {
      return {
        "status": "error",
        "message": "Method $method not supported for Update Settings Option API",
    ...
    if (!params.containsKey('group_id') || params['group_id']!.isEmpty ||
        !params.containsKey('option_id') || params['option_id']!.isEmpty) {
      return {
        "status": "error",
    ...
    try {
      ...
      jsonData.removeWhere((key, value) => value == null || (value is String && value.isEmpty));
