        ...
        .map((operation) {
          ...
          if (parts.length >= 3) {
            return Create(
              ...
              individualUse: parts.length > 3 ? parts[3].trim() == 'true' : null,
              excludeSaleItems: parts.length > 4 ? parts[4].trim() == 'true' : null,
        ...
        .map((operation) {
          ...
          if (parts.length >= 4) {
            return Update(
              ...
              individualUse: parts.length > 4 ? parts[4].trim() == 'true' : null,
              excludeSaleItems: parts.length > 5 ? parts[5].trim() == 'true' : null,
  ...
  Map<String, List<ApiField>> get requiredFields => {
        'PATCH': [
          const ApiField(
            ...
            hint: 'Create operations in format: code:amount:type,code2:amount2:type2',
            isRequired: false,
          ),
          const ApiField(
            name: 'update_operations',
            label: 'Update Operations',
            hint: 'Update operations in format: id:code:amount:type,id2:code2:amount2:type2',
            isRequired: false,
          ),
          const ApiField(
