        ...
        .map((operation) {
          ...
          if (parts.length >= 2) {
            return Create(
              ...
              shippingLines: parts.length > 5 ? _parseShippingLines(parts[5]) : null,
            );
          }
          return null;
        })
        ...
        .map((item) {
          ...
          if (parts.length >= 2) {
            return LineItem(
              ...
              variationId: parts.length > 2 ? int.tryParse(parts[2].trim()) : null,
            );
          }
          return null;
        })
  ...
  Map<String, List<ApiField>> get requiredFields => {
        'PATCH': [
          const ApiField(
            ...
            hint: 'Create operations in format: status:currency,status2:currency2',
            isRequired: false,
          ),
          const ApiField(
