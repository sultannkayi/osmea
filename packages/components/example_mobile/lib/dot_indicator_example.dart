...
class _DotIndicatorExampleState extends State<DotIndicatorExample> {
  ...
  Widget build(BuildContext context) {
    return OsmeaComponents.scaffold(
      ...
      appBar: OsmeaComponents.appBar(
        title: OsmeaComponents.text('Dot Indicators'),
  ...
  Widget _buildHeartPulseCard() {
    return _buildInteractiveCard(
      ...
      itemCount: 5,
      currentIndex: _mainDemoIndex,
      onTap: (index) => _updateIndex(index, (i) => setState(() => _mainDemoIndex = i)),
  ...
  Widget _buildRectangleCard() {
    return _buildInteractiveCard(
      ...
      onTap: (index) => _updateIndex(index, (i) => setState(() => _styleCurrentIndex = i)),
      builder: () => OsmeaComponents.dotIndicator(
        itemCount: 5,
        currentIndex: _styleCurrentIndex,
        ...
        size: DotIndicatorSize.medium,
        spacing: 12,
        onDotTapped: (index) => _updateIndex(index, (i) => setState(() => _styleCurrentIndex = i)),
      ),
    );
  }
  ...
  Widget _buildArrowCard() {
    return _buildInteractiveCard(
      ...
      onTap: (index) => _updateIndex(index, (i) => setState(() => _customColorIndex = i)),
      builder: () => OsmeaComponents.dotIndicator(
        itemCount: 5,
        currentIndex: _customColorIndex,
        ...
        size: DotIndicatorSize.medium,
        spacing: 14,
        onDotTapped: (index) => _updateIndex(index, (i) => setState(() => _customColorIndex = i)),
      ),
    );
  }
    ...
    return OsmeaComponents.row(
      children: [
        ...
        OsmeaComponents.expanded(
          ...
          size: size,
          variant: DotIndicatorVariant.primary,
          onDotTapped: (index) => _updateIndex(index, (i) => setState(() => _sizeCurrentIndex = i)),
        ),
      ],
    );
  }
  ...
  Widget _buildStyleCard({
    ...
    return Container(
      ...
      child: Material(
        ...
        child: InkWell(
          borderRadius: BorderRadius.circular(12),
          onTap: () => _updateIndex(_styleCurrentIndex + 1, (i) => setState(() => _styleCurrentIndex = i)),
