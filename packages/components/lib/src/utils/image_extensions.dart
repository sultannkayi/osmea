...
extension ImageCacheStrategyExtensions on ImageCacheStrategy {
  /// Get cache size limit in MB
  int getCacheSizeLimit() {
    switch (this) {
      case ImageCacheStrategy.aggressive:
        return 200; // 200MB
      case ImageCacheStrategy.balanced:
        return 100; // 100MB
      case ImageCacheStrategy.conservative:
        return 50; // 50MB
      case ImageCacheStrategy.none:
        return 0; // No cache
      case ImageCacheStrategy.refresh:
        return 25; // Minimal cache
    }
  }
  ...
  bool get useMemoryCache {
    return this != ImageCacheStrategy.none;
  }

  /// Check if strategy should use disk cache
  bool get useDiskCache {
    return this == ImageCacheStrategy.aggressive ||
        this == ImageCacheStrategy.balanced;
  }
}
