      ...
      body: OsmeaComponents.singleChildScrollView(
        ...
        child: OsmeaComponents.column(
          ...
          children: [
            ...
            OsmeaComponents.sizedBox(height: 32),
            _buildSectionTitle(
                context, 'Interactive Padding (Using Composition)'),
        ...
        _buildExampleWithCaption(
          ...
          OsmeaComponents.padding(
            ...
            child: _buildColoredBox(context,
                color: OsmeaColors.blue, text: 'Padding.all(16)'),
          ),
        ),
        ...
        _buildExampleWithCaption(
          ...
          OsmeaComponents.padding(
            ...
            child: _buildColoredBox(context,
                ...
                text: 'Padding.symmetric(horizontal: 24)'),
          ),
        ),
        OsmeaComponents.sizedBox(height: 16),
        _buildExampleWithCaption(
        ...
        _buildExampleWithCaption(
          ...
          OsmeaComponents.padding(
            ...
            child: _buildColoredBox(context,
                ...
                text: 'Padding.fromLTRB(32, 8, 16, 24)'),
          ),
        ),
      ],
    );
        ...
        _buildExampleWithCaption(
          ...
          OsmeaComponents.container(
            ...
            child: OsmeaComponents.padding(
              padding: const EdgeInsets.all(16),
              child: _buildColoredBox(context,
                  color: OsmeaColors.meadow, text: 'With BoxShadow'),
            ),
          ),
        ),
        OsmeaComponents.sizedBox(height: 16),
        _buildExampleWithCaption(
          ...
          OsmeaComponents.container(
            ...
            child: OsmeaComponents.padding(
              padding: const EdgeInsets.all(16),
              child: _buildColoredBox(context,
                  color: OsmeaColors.white, text: 'With Gradient'),
            ),
          ),
        ),
      ],
          ...
          GestureDetector(
            ...
            child: OsmeaComponents.container(
              ...
              child: OsmeaComponents.padding(
                padding: const EdgeInsets.all(16),
                child: _buildColoredBox(context,
                    color: OsmeaColors.azureWave, text: 'Tap Me!'),
              ),
            ),
          ),
        ),
      ...
      children: [
        _buildExampleWithCaption(
          ...
          OsmeaComponents.padding(
            padding: const EdgeInsets.all(16),
            child: _buildColoredBox(context,
                color: OsmeaColors.nordicBlue, text: 'Padding.all(16)'),
          ),
        ),
        OsmeaComponents.sizedBox(height: 16),
        _buildExampleWithCaption(
