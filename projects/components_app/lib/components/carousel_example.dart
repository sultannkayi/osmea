          ...
          children: [
            ...
            OsmeaComponents.carousel(
              ...
              onItemTaps: [
                ...
                () => _openUrl(
                    'https://github.com/masterfabric-mobile/osmea/pulse'),
                () => _openUrl(
                    'https://github.com/masterfabric-mobile/osmea/stargazers'),
                () => _openUrl(
                    'https://github.com/masterfabric-mobile/osmea/security'),
                () => _openUrl(
                    'https://github.com/masterfabric-mobile/osmea/network/members'),
                () => _openUrl(
                    'https://github.com/masterfabric-mobile/osmea/settings'),
              ],
              showArrows: true,
