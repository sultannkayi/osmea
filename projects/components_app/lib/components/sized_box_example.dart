      ...
      children: [
        ...
        _buildExampleWithCaption(
          ...
          OsmeaComponents.sizedBox(
            width: 150,
            child: _buildColoredBox(context,
                color: OsmeaColors.forestHeart, text: 'Width: 150'),
          ),
        ),
        OsmeaComponents.sizedBox(height: 16),
        _buildExampleWithCaption(
          ...
          OsmeaComponents.sizedBox(
            height: 60,
            child: _buildColoredBox(context,
                color: OsmeaColors.sunsetGlow, text: 'Height: 60'),
          ),
        ),
        OsmeaComponents.sizedBox(height: 16),
        _buildExampleWithCaption(
          ...
          OsmeaComponents.column(
            children: [
              _buildColoredBox(context,
                  color: OsmeaColors.purple, text: 'Before Spacer'),
              OsmeaComponents.sizedBox(height: 30),
              _buildColoredBox(context,
                  color: OsmeaColors.purple, text: 'After Spacer'),
            ],
          ),
        ),
      ],
          ...
          OsmeaComponents.sizedBox(
            ...
            child: OsmeaComponents.container(
              ...
              child: OsmeaComponents.center(
                  child: OsmeaComponents.text('With Container Child')),
            ),
          ),
        ),
        OsmeaComponents.sizedBox(height: 16),
